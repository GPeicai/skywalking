...
# start applications
export agent_opts="
    -javaagent:${JACOCO_HOME}/jacocoagent.jar=classdumpdir=${JACOCO_HOME}/classes/${SCENARIO_NAME},destfile=${JACOCO_HOME}/${SCENARIO_NAME}.exec,classdumpdir=${JACOCO_HOME}/classes/${SCENARIO_NAME},includes=org.apache.skywalking.*,excludes=org.apache.skywalking.apm.dependencies.*
